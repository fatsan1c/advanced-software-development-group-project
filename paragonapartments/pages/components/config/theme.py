...
This module defines all UI colors, corner radii, and other styling constants
...
SECONDARY_GRAY = ("gray70", "gray25")
SECONDARY_GRAY_HOVER = ("gray75", "gray30")
TEXT_COLOR = ("gray15", "gray92")
DISABLED_TEXT_COLOR = "gray50"

# Corner Radius Constants (in pixels)
